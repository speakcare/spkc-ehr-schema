...
class TestPCCAssessmentSchema(unittest.TestCase):
    ...
    def test_mhcs_therapy_slp_screen(self):
        """Test MHCS Therapy - SLP Screen (templateId: 21243581)."""
        pcc = PCCAssessmentSchema()

        # Verify the assessment is registered
        self.assertIn(21243581, pcc.list_assessments())

        # Test JSON schema generation
        json_schema = pcc.get_json_schema(21243581)
        self.assertEqual(json_schema["title"], "MHCS Therapy - SLP Screen")
        self.assertIn("sections", json_schema["properties"])

        # Test field metadata collection
        field_metadata = pcc.get_field_metadata(21243581)
        self.assertGreater(len(field_metadata), 0)
        ...
        for field in field_metadata:
            ...
            if len(level_keys) > 1 and level_keys[0] == "sections":
                section_keys.add(level_keys[1])
        self.assertIn('Cust.MHCS Therapy - SLP Screen', section_keys)
...
21243581]
    ...
    def test_get_assessment_templates_ids(self):
        ...
        expected_templates = [
            ...
            {"template_id": 21243581, "name": "MHCS Therapy - SLP Screen"}
        ]
    ...
    def test_assessment_field_counts(self):
        ...
        expected_counts = {
            ...
            21243581: 8,   # MHCS Therapy - SLP Screen
        }
    ...
    def test_assessment_section_structure(self):
        ...
        assessments = [
            ...
            (21243581, "MHCS Therapy - SLP Screen")
        ]
