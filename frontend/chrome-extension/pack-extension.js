...
const zipFileName = `speakcare-extension-${newVersion}.zip`;
const zipCommand = `zip -r ${zipFileName} build`;
...
console.log(`Pack-extension completed successfully for version ${newVersion}.`);
